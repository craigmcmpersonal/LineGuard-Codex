...
from develop.persistence.hedge_rule_bet_slip_storage_adapter import HedgeRuleBetSlipStorageAdapter
from develop.persistence.model.hedge_rule_bet_slip import HedgeRuleBetSlip


class HedgeRuleStorageAdapter(BaseStorageAdapter[HedgeRule]):
...
"""
    ...
    def __init__(self, connection: Any):
        ...
        self._bets_slips = HedgeRuleBetSlipStorageAdapter(connection)
